...
- **ค้นหาวันที่** - เลือกวันที่จากปุ่ม (7 วันข้างหน้า + วันอื่น)
- **ค้นหาทั้งหมด** - ค้นหาแบบอิสระ (รองรับ text และ date)
...
- **เพิ่มกิจกรรม** - Guided flow 3 ขั้นตอน
  1. ชื่อกิจกรรม
  2. รายละเอียด
  3. วันที่ (เลือกจากปุ่ม 7 วัน + วันอื่น)
...
**การแก้ไข:**
```python
# แบ่งเมนูออกเป็นหลายขั้น
def create_admin_quick_reply():
    return QuickReply(items=[
        # จำกัดไม่เกิน 13 items
    ])
```
